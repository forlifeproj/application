...
const (
	...
	FLSvrFail       = 1000
	FLInvalidReq    = 1001
	HttpRequestFail = 1051
	HttpRspFail     = 1052
	HttpReadRspFail = 1053
	DBQueryErr      = 1101
	DBInsertErr     = 1102
	DBUpdateErr     = 1103
...
var (
	...
	ErrDBQueryail   = &Errno{Code: DBQueryErr, Message: "数据库查询失败"}
	ErrDBInsertFail = &Errno{Code: DBInsertErr, Message: "数据库插入失败"}
	ErrDBUpdateFail = &Errno{Code: DBUpdateErr, Message: "数据库更新失败"}
	// http网关
